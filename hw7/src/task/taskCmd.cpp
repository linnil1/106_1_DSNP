...
//----------------------------------------------------------------------
CmdExecStatus TaskInitCmd::exec(const string& option)
{
  // check option
  string token;
...
//----------------------------------------------------------------------
CmdExecStatus TaskNewCmd::exec(const string& option)
{
  if (!taskMgr) {
...
//----------------------------------------------------------------------
CmdExecStatus TaskRemoveCmd::exec(const string& option)
{
  if (!taskMgr) {
    cerr << "Error: task manager is not initialized!" << endl;
    return CMD_EXEC_ERROR;
...
//----------------------------------------------------------------------
CmdExecStatus TaskQueryCmd::exec(const string& option)
{
  if (!taskMgr) {
    cerr << "Error: task manager is not initialized!" << endl;
    return CMD_EXEC_ERROR;
...
//----------------------------------------------------------------------
CmdExecStatus TaskAssignCmd::exec(const string& option)
{
  if (!taskMgr) {
    cerr << "Error: task manager is not initialized!" << endl;
    return CMD_EXEC_ERROR;
