...
//----------------------------------------------------------------------
CmdExecStatus AdtResetCmd::exec(const string& option)
{
  // check option
  string token;
...
//----------------------------------------------------------------------
CmdExecStatus AdtAddCmd::exec(const string& option)
{
  // check option
...
//----------------------------------------------------------------------
CmdExecStatus AdtDeleteCmd::exec(const string& option)
{
  // check option
  vector<string> options;
...
//    ADTSort
//----------------------------------------------------------------------
CmdExecStatus AdtSortCmd::exec(const string& option)
{
  // check option
  vector<string> options;
  if (!CmdExec::lexOptions(option, options))
